            ...
            <div id="page-inner">
                ...
                <!-- Advanced Tables -->
                    <div class="panel panel-default">
                                    <?php
                                        $i = 0;
                                        $sql	= 'select * from pendaftaran1 where poli = "umum" and tgl_masuk = "'.date("Y-m-d").'" order by tgl_masuk asc';
                        ...
                        <div class="panel-body">
                            ...
                            <a class="btn btn-primary" href="umum.php"><i class="fa fa-success"></i>  Tampilkan semua</a>
                            <!--akhir modal--!>
                        </div>
                    </div>
                    <!--End Advanced Tables -->
